 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Chat my()
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|ChatUsers newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|ChatUsers newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|ChatUsers query()
 * @method static \Illuminate\Database\Eloquent\Builder|ChatUsers whereChatId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ChatUsers whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ChatUsers whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ChatUsers whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|ChatUsers whereUserId($value)
 */
	class ChatUsers extends \Eloquent {}
}
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \Illuminate\Database\Eloquent\Collection<int, User> $chats
